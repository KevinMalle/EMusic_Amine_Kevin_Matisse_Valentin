...
use App\Repository\ClasseDinstrumentRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=ClasseDinstrumentRepository::class)
 */
class ClasseDinstrument
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\OneToMany(targetEntity=TypeInstrument::class, mappedBy="classeDinstrument")
     */
    ...
    public function addTypeInstrument(TypeInstrument $typeInstrument): self
    {
        if (!$this->typeInstruments->contains($typeInstrument)) {
            ...
            $typeInstrument->setClasseDinstrument($this);
        }
    ...
    public function removeTypeInstrument(TypeInstrument $typeInstrument): self
    {
        if ($this->typeInstruments->removeElement($typeInstrument)) {
            ...
            if ($typeInstrument->getClasseDinstrument() === $this) {
                $typeInstrument->setClasseDinstrument(null);
            }
        }
